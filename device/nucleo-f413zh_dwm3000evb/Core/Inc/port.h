...
#define DECAIRQ_EXTI_IRQn2       (EXTI9_5_IRQn)
...
#define DECAIRQ2                    DW_IRQ2_Pin
#define DECAIRQ2_GPIO               DW_IRQ2_GPIO_Port
...
#define WAIT_200uSEC Sleep(1) /*This is should be a delay of 200uSec at least. In our example it is more than that*/
     ...
     */
    void writetoLCD(uint32_t bodylength, uint8_t rs_enable, const uint8_t *bodyBuffer);
